...
def gui():
    ...
    def pattern1(fig_pattern, datatype):
        ...
        with output3:
            display(
                widgets.VBox(
                    [
                        widgets.HBox([widgets.Label("CSV Table Name"), dataname]),
                        savedata,
                    ]
                )
            )
    ...
    def shows(button):
        ...
        with controloutput1:
            ...
            display(
                widgets.VBox(
                    [widgets.HBox([widgets.Label("Curve Name"), figname]), savefig]
                )
            )
        dataoldname.value = dataname.value
        figoldname.value = figname.value
        dataout = widgets.interactive_output(
            pattern1, {"fig_pattern": fig_pattern, "datatype": datatype}
        )
        os.chdir(opath)
    ...
    def shows2(button):
        ...
        for csv in csvs:
            ...
            try:
                ...
                warnings.warn(
                    "'{0}' is not the file aboue stress-strain curve.".format(csv)
                )
                continue
            ...
            display(
                widgets.VBox(
                    [
                        ...
                        savedata,
                        widgets.HBox(
                            [widgets.Label("Delete all combined files"), delete]
                        ),
                    ]
                )
            )
        ...
        with controloutput1:
            ...
            display(
                widgets.VBox(
                    [
                        widgets.HBox([widgets.Label("Curve Name"), figname]),
                        savefig,
                        widgets.HBox(
                            [widgets.Label("Delete all combined files"), delete]
                        ),
    ...
    file1 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 1",
        layout=widgets.Layout(width="98.5%"),
    )
    file2 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 2",
        layout=widgets.Layout(width="98.5%"),
    )
    file3 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 3",
        layout=widgets.Layout(width="98.5%"),
    )
    file4 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 4",
        layout=widgets.Layout(width="98.5%"),
    )
    file5 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 5",
        layout=widgets.Layout(width="98.5%"),
    )
    file6 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 6",
        layout=widgets.Layout(width="98.5%"),
    )
    file7 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 7",
        layout=widgets.Layout(width="98.5%"),
    )
    file8 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 8",
        layout=widgets.Layout(width="98.5%"),
    )
    file9 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 9",
        layout=widgets.Layout(width="98.5%"),
    )
    file10 = widgets.Combobox(
        placeholder="Input the file name",
        options=options,
        description="ORCA File 10",
        layout=widgets.Layout(width="98.5%"),
    )
    ...
    options2.sort()
    csv1 = widgets.Combobox(
        placeholder="Input the file name",
        options=options2,
        description="CSV File 1",
        layout=widgets.Layout(width="98.5%"),
    )
    csv2 = widgets.Combobox(
        placeholder="Input the file name",
        options=options2,
        description="CSV File 2",
        layout=widgets.Layout(width="98.5%"),
    )
    csv3 = widgets.Combobox(
        placeholder="Input the file name",
        options=options2,
        description="CSV File 3",
        layout=widgets.Layout(width="98.5%"),
    )
    csv4 = widgets.Combobox(
        placeholder="Input the file name",
        options=options2,
        description="CSV File 4",
        layout=widgets.Layout(width="98.5%"),
    )
    csv5 = widgets.Combobox(
        placeholder="Input the file name",
        options=options2,
        description="CSV File 5",
        layout=widgets.Layout(width="98.5%"),
    )
    csv6 = widgets.Combobox(
        placeholder="Input the file name",
        options=options2,
        description="CSV File 6",
        layout=widgets.Layout(width="98.5%"),
    )

    showcurve = widgets.Button(
        description="Create Curve and Table",
        layout=widgets.Layout(width="98.5%"),
        style=dict(font_weight="bold", text_decoration="underline"),
    )
    showcurve2 = widgets.Button(
        description="Create Curve and Table",
        layout=widgets.Layout(width="98.5%"),
        style=dict(font_weight="bold", text_decoration="underline"),
    )
    datatype = widgets.Dropdown(
        ...
        options=["Energy", "Gibbs"],
        value="Energy",
        layout=widgets.Layout(width="98.5%"),
    )
    fig_pattern = widgets.Dropdown(
        options=["line", "bar"], value="line", layout=widgets.Layout(width="80%")
    )
    dataname = widgets.Text(value="Untitled")
    dataoldname = widgets.Text()
    savedata = widgets.Button(
        description="Save CSV Table", layout=widgets.Layout(width="98.5%")
    )
    figname = widgets.Text(value="Untitled")
    figoldname = widgets.Text()
    savefig = widgets.Button(
        description="Save Curve", layout=widgets.Layout(width="98.5%")
    )
    ...
    with output4:
        display(
            widgets.VBox([loc, title2, csv1, csv2, csv3, csv4, csv5, csv6, showcurve2])
        )
